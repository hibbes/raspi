...
if(mysqli_num_rows($ergebnis)==0){
	$eintrag = "INSERT INTO Anmeldungen (Eintrags_ID, Klasse, Name, Vorname, Rufname, Geburtstag, Geburtsort, Geburtsland, Geschlecht, Religion, RU, Land, Land2, Strasse, HausNr, PLZ, Ort, 
	Muttersprache, Erz1Name, Erz1Vorname, Erz1Geschlecht, Erz1Strasse, Erz1HausNr, Erz1PLZ, Erz1Ort,
	Erz1Telefon, Erz1Telefon2 , Erz1Handy, Erz1Email, Erz2Vorname, Erz2Name, Erz2Geschlecht, Erz2Strasse, Erz2HausNr, Erz2PLZ, Erz2Ort,
	Erz2Telefon, Erz2Telefon2, Erz2Handy, Erz2Email, AbgebendeSchule, Sprachwahl, Foto_Einw, Notfallnr, Geschwister, Klassenpartner, 
	nichtKlassenpartner) VALUES
	('$eintrags_id', '5', '$name', '$vorname', '$rufname', '$geburtstag', '$geburtsort', '$geburtsland', '$geschlecht', '$religion', '$ru', '$land', '$land2', '$strasse', '$hausnummer', '$plz', '$ort',  
	 '$muttersprache', '$erz1name', '$erz1vorname', '$erz1geschlecht', '$erz1strasse', '$erz1hausnummer' ,
	 '$erz1plz', '$erz1ort', '$erz1telefon', '$erz1telefon2', '$erz1handy', '$erz1email',
	 '$erz2vorname', '$erz2name', '$erz2geschlecht', '$erz2strasse', '$erz2hausnummer', '$erz2plz', '$erz2ort', '$erz2telefon', '$erz2telefon2', '$erz2handy', '$erz2email' 
	 '$abgebendeschule', '$sprachwahl', '$foto', '$notfallnr', '$geschwister', '$mit', '$ohne')";
